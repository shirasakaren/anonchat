    ...
    <div className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-6 py-12">
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-raised)] p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-[var(--text-muted)]">
          Save your recovery key if you want to access this account from another device or after clearing your
          browser data. <strong>If you lose it and clear this browser, this conversation is gone for good.</strong>
        </p>
        <div className="mt-4">
